...
var fightOrSkip = function() {
    //ask player if they'd lik to fight or skip using fightOrSkip function
    ...
    while(playerInfo.health > 0 && enemy.health > 0) {
       ...
       if (isPlayerTurn) {
           ...
           if (fightOrSkip()) {
            ...
            console.log(playerInfo.name + " attacked " + enemy.name + ". " + enemy.name + 
